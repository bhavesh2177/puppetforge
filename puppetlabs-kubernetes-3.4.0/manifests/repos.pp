...
class kubernetes_v1_10_0::repos (
  ...
  Optional[String] $kubernetes_apt_location = $kubernetes_v1_10_0::kubernetes_apt_location,
  Optional[String] $kubernetes_apt_release  = $kubernetes_v1_10_0::kubernetes_apt_release,
  Optional[String] $kubernetes_apt_repos    = $kubernetes_v1_10_0::kubernetes_apt_repos,
  Optional[String] $kubernetes_key_id       = $kubernetes_v1_10_0::kubernetes_key_id,
  Optional[String] $kubernetes_key_source   = $kubernetes_v1_10_0::kubernetes_key_source,
  Optional[String] $kubernetes_yum_baseurl  = $kubernetes_v1_10_0::kubernetes_yum_baseurl,
  Optional[String] $kubernetes_yum_gpgkey   = $kubernetes_v1_10_0::kubernetes_yum_gpgkey,
  Optional[String] $docker_apt_location     = $kubernetes_v1_10_0::docker_apt_location,
  Optional[String] $docker_apt_release      = $kubernetes_v1_10_0::docker_apt_release,
  Optional[String] $docker_apt_repos        = $kubernetes_v1_10_0::docker_apt_repos,
  Optional[String] $docker_yum_baseurl      = $kubernetes_v1_10_0::docker_yum_baseurl,
  Optional[String] $docker_yum_gpgkey       = $kubernetes_v1_10_0::docker_yum_gpgkey,
  Optional[String] $docker_key_id           = $kubernetes_v1_10_0::docker_key_id,
  Optional[String] $docker_key_source       = $kubernetes_v1_10_0::docker_key_source,
  Boolean $manage_docker                    = $kubernetes_v1_10_0::manage_docker,
  Boolean $create_repos                     = $kubernetes_v1_10_0::create_repos,
