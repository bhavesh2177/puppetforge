...
class kubernetes_v1_11_0 (
  ...
  String $kubernetes_package_version           = $facts['os']['family'] ? {
                                                    ...
                                                    'RedHat' => $kubernetes_v1_11_0::kubernetes_version,
                                                  },
  ...
  if $controller {
    include kubernetes_v1_11_0::repos
    include kubernetes_v1_11_0::packages
    include kubernetes_v1_11_0::config::kubeadm
    include kubernetes_v1_11_0::service
    include kubernetes_v1_11_0::cluster_roles
    include kubernetes_v1_11_0::kube_addons
    include kubernetes_v1_11_0::keepalived
    contain kubernetes_v1_11_0::repos
    contain kubernetes_v1_11_0::packages
    contain kubernetes_v1_11_0::config::kubeadm
    contain kubernetes_v1_11_0::service
    contain kubernetes_v1_11_0::cluster_roles
    contain kubernetes_v1_11_0::kube_addons
    contain kubernetes_v1_11_0::keepalived
    ...
    Class['kubernetes_v1_11_0::repos']
      ...
      -> Class['kubernetes_v1_11_0::service']
      -> Class['kubernetes_v1_11_0::cluster_roles']
      -> Class['kubernetes_v1_11_0::kube_addons']
  }
  ...
  if $worker {
    ...
    unless $kubernetes_version =~ /^1.1(0|1)/ {
      contain kubernetes_v1_11_0::config::worker
      Class['kubernetes_v1_11_0::config::worker'] -> Class['kubernetes_v1_13_0::service']
    }
    contain kubernetes_v1_11_0::service
    contain kubernetes_v1_11_0::cluster_roles
