...
describe 'kubernetes', :type => :class do
  ...
  context 'with controller => true' do
    ...
    it { should contain_class('kubernetes_v1_13_0::repos') }
    it { should contain_class('kubernetes_v1_13_0::packages')}
    it { should contain_class('kubernetes_v1_13_0::config::kubeadm')}
    it { should contain_class('kubernetes_v1_13_0::service')}
    it { should contain_class('kubernetes_v1_13_0::cluster_roles')}
    it { should contain_class('kubernetes_v1_13_0::kube_addons')}
  end
  ...
  context 'with worker => true and version => 1.10.2' do
    ...
    it { should contain_class('kubernetes_v1_13_0::repos') }
    it { should contain_class('kubernetes_v1_13_0::packages')}
    it { is_expected.to_not contain_class('kubernetes_v1_13_0::config::kubeadm')}
    it { is_expected.to_not contain_class('kubernetes_v1_13_0::config::worker')}
    it { should contain_class('kubernetes_v1_13_0::service')}
  end
  ...
  context 'with worker => true and version => 1.12.2' do
    ...
    it { is_expected.to_not contain_class('kubernetes_v1_13_0::config::kubeadm')}
    it { is_expected.to contain_class('kubernetes_v1_13_0::config::worker')}
  end
