class kubecontainer::v1_10::generate_certs inherits kubecontainer {
  ...
  file {'install_cfssl':
    ...
    mode    => "0755",
    source  => "puppet:///modules/kubecontainer/v1_10/downloads/cfssl"
  }

  file {'install_cfssljson':
    path    => "/usr/local/bin/cfssljson",
    mode    => "0755",
    source  => "puppet:///modules/kubecontainer/v1_10/downloads/cfssljson",
  ...
  file {'ssl_etcd_ca_crt':
    ...
    mode    => "0600",
    content => template("kubecontainer/v1_10/ssl/etcd/ca.crt"),
  ...
  file {'ssl_etcd_ca_key':
    ...
    mode    => "0644",
    content => template("kubecontainer/v1_10/ssl/etcd/ca.key"),
  ...
  file {'ssl_kubernetes_ca_crt':
    ...
    mode    => "0644",
    content => template("kubecontainer/v1_10/ssl/kubernetes/ca.crt"),
  ...
  file {'ssl_kubernetes_ca_key':
    ...
    mode    => "0600",
    content => template("kubecontainer/v1_10/ssl/kubernetes/ca.key"),
  ...
  file {'discovery_token_hash':
    ...
    mode    => "0644",
    content => template("kubecontainer/v1_10/ssl/kubernetes/discovery_token_hash"),
  ...
  file {'ssl_kubernetes_sa_pub':
    ...
    mode    => "0644",
    content => template("kubecontainer/v1_10/ssl/kubernetes/sa.pub"),
  ...
  file {'ssl_kubernetes_sa_key':
    ...
    mode    => "0600",
    content => template("kubecontainer/v1_10/ssl/kubernetes/sa.key"),
