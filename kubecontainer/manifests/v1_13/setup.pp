class kubecontainer::v1_13::setup inherits kubecontainer {
  ...
  if($action_lower == 'install') {
	...
	# Kubernetes Class Built In
        ...
        kubelet_extra_arguments => ["cluster-dns: '$kubecontainer::dns_ip'","cluster-domain: '$kubecontainer::dns_cluster_domain'","port: '$kubecontainer::nod_port'","hostname-override: '$node_label'","kube-reserved: '$kubecontainer::nod_kube_reserved_cpu,$kubecontainer::nod_kube_reserved_ram'","system-reserved: '$kubecontainer::nod_sys_reserved_cpu,$kubecontainer::nod_sys_reserved_ram'","max-pods: '110'","allow-privileged: 'true'"],
        api_server_count        => 0,
